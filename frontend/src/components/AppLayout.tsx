...
export function AppLayout() {
  ...
  // A landing pública (raiz deslogada) tem layout próprio de largura cheia — sem a moldura do app.
  const naLanding = location.pathname === '/' && !logado;
